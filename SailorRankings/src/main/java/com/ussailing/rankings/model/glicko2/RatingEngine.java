...
public class RatingEngine{
	 ...
	 * @param results
	 */
	private void calculateNewRating(Player player, List<Result> results) {
		...
		// note that the newly calculated rating values are stored in a "working" area in the Player object
	 ...
	 * @return
	 */
	private double v(Player player, List<Result> results) {
		double v = 0.0;
	 ...
	 * @return delta
	 */
	private double delta(Player player, List<Result> results) {
	 ...
	 */
	private double outcomeBasedRating(Player player, List<Result> results) {
